...
class Primer():
    ...
    def __init__(self, snp_id, allele, sequence, direction, desired_tm: float = 60.0, diff: float = 2.0, homodimer_goal: float = -3.0, hairpin_goal: float = -3.0, target_gc = 50.0):
